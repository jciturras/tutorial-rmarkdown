...
kable(tabla,format = "html", booktabs =TRUE, escape = FALSE, align = c("lcccc"),
      ...
      col.names = linebreak(c("Grupo <br> de  edad", "Muertes ", "Persona-años ",
                              "Muertes", "Persona-años"), align = "c")) %>%
...
**PISTA:** Si desdeas conocer más detalles sobre el uso de  **RMarkdown**, puedes encontrar [aquí](https://rmarkdown.rstudio.com/lesson-1.html) una guía completa de las funcionalidades del paquete.
</div>
